...
public class NgnSubscriptionAffiliationEventArgs extends NgnEventArgs{
	...
	public NgnSubscriptionAffiliationEventArgs(long sessionId, NgnSubscriptionAffiliationEventTypes type, short sipCode, String phrase,
	...
	public NgnSubscriptionAffiliationEventArgs(Parcel in){
    	super(in);
    }

    public static final Creator<NgnSubscriptionAffiliationEventArgs> CREATOR = new Creator<NgnSubscriptionAffiliationEventArgs>() {
        public NgnSubscriptionAffiliationEventArgs createFromParcel(Parcel in) {
            return new NgnSubscriptionAffiliationEventArgs(in);
        }

        public NgnSubscriptionAffiliationEventArgs[] newArray(int size) {
            return new NgnSubscriptionAffiliationEventArgs[size];
        }
    };
    ...
    public NgnSubscriptionAffiliationEventTypes getEventType(){
        return mType;
    }
	...
	protected void readFromParcel(Parcel in) {
		...
		mType = Enum.valueOf(NgnSubscriptionAffiliationEventTypes.class, in.readString());
