...
public class NgnSubscriptionCMSEventArgs extends NgnEventArgs{
	private final static String TAG = Utils.getTAG(NgnSubscriptionCMSEventArgs.class.getCanonicalName());

	public static final String ACTION_SUBSCRIBTION_CMS_EVENT = TAG + ".ACTION_SUBSCRIBTION_CMS_EVENT";

	private long mSessionId;
	private NgnSubscriptionCMSEventTypes mType;
	...
	public NgnSubscriptionCMSEventArgs(long sessionId, NgnSubscriptionCMSEventTypes type, short sipCode, String phrase,
	...
	public NgnSubscriptionCMSEventArgs(Parcel in){
    	super(in);
    }

    public static final Creator<NgnSubscriptionCMSEventArgs> CREATOR = new Creator<NgnSubscriptionCMSEventArgs>() {
        public NgnSubscriptionCMSEventArgs createFromParcel(Parcel in) {
            return new NgnSubscriptionCMSEventArgs(in);
        }

        public NgnSubscriptionCMSEventArgs[] newArray(int size) {
            return new NgnSubscriptionCMSEventArgs[size];
        }
    };
    ...
    public NgnSubscriptionCMSEventTypes getEventType(){
        return mType;
    }
	...
	protected void readFromParcel(Parcel in) {
		...
		mType = Enum.valueOf(NgnSubscriptionCMSEventTypes.class, in.readString());
