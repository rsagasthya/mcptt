...
public class IMEIRangeType {
    ...
    @ElementList(required=false,inline=true,entry = "SNR")
    protected List<SnrType> snr;
    @ElementList(required=false,inline=true,entry = "SNR-range")
    protected List<SNRRangeType> sNRRange;
    ...
    public List<SNRRangeType> getsNRRange() {
        return sNRRange;
    }

    public void setsNRRange(List<SNRRangeType> sNRRange) {
