...
public class NgnRegistrationSession extends NgnSipSession {
    ...
    public NgnRegistrationSession(NgnSipStack sipStack){
        ...
        */
        ...
        super.addCaps("+g.3gpp.icsi-ref", "\"urn%3Aurn-7%3A3gpp-service.ims.icsi.mcptt\"");
     ...
     * @return true if succeed and false otherwise
     */
    public boolean register(String mcpttInfo){
        if(mcpttInfo==null)return mSession.register_();
        return mSession.registerWithMcpttInfo(mcpttInfo.getBytes());
    }
