...
@Root(strict=false, name = "Relay-MCPTT-Group-ID")
public class RelayMCPTTGroupIDType {

    @Element(required = false , name = "MCPTT-Group-ID")
    protected String mcpttGroupID;
    @Element(required = false , name = "Relay-Service-Code")
    ...
    public void setRelayServiceCode(String value) {
        this.relayServiceCode = value;
    }
