...
public:
	...
	int32_t sessionHold(twrap_media_type_t media);
	int32_t sessionResume(twrap_media_type_t media);
	...
	static bool defaultsSetPoCQoE(tmedia_poc_qoe_profile_t profile, tmedia_poc_qoe_profile_strength_t strength);
