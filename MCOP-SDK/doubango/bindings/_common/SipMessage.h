...
public:
	...
	int getSdpHeaderMPort(const char* media, unsigned index /*= 0*/);
	int getSdpHeaderMPort(const char* media);
	char* getSdpHeaderCAddr(const char* media, unsigned index /*= 0*/);
	char* getSdpHeaderCAddrType(const char* media, unsigned index /*= 0*/);
#if !defined(SWIG)
...
public:
	...
	unsigned getSipContentSdp(void* output, unsigned maxsize);
	unsigned getSipContentMbms(void* output, unsigned maxsize);
	unsigned getSipContentContetType(void* output, unsigned maxsize,char* content_type);
