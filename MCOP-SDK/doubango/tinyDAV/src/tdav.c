...
#include "tinydav/mcptt/tdav_session_mcptt.h" // MCPTT
...
int tdav_init()
{
	...
	if(__b_initialized){
		...
		TSK_DEBUG_INFO("TINYDAV init now");
	}
...
#   endif
	...
	("text/plain", tmedia_content_dummy_plugin_def_t);
	...
	*/
	...
	//MCPTT (PTT)
	tmedia_session_plugin_register(tdav_session_mcptt_plugin_def_t);
	tmedia_session_plugin_register(tdav_session_mbmsaudio_plugin_def_t);
#endif
...
#endif
	TSK_DEBUG_INFO("Register codecs now");
	tmedia_codec_plugin_register(tdav_codec_msrp_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_msrp_plugin_def_t->name, tdav_codec_msrp_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_t140_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_t140_plugin_def_t->name, tdav_codec_t140_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_bfcp_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_bfcp_plugin_def_t->name, tdav_codec_bfcp_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_red_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_red_plugin_def_t->name, tdav_codec_red_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_g711a_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_g711a_plugin_def_t->name, tdav_codec_g711a_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_g711u_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_g711u_plugin_def_t->name, tdav_codec_g711u_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_g722_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_g722_plugin_def_t->name, tdav_codec_g722_plugin_def_t->desc);
#if HAVE_OPENCORE_AMR
	tmedia_codec_plugin_register(tdav_codec_amrnb_oa_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_amrnb_oa_plugin_def_t->name, tdav_codec_amrnb_oa_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_amrnb_be_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_amrnb_be_plugin_def_t->name, tdav_codec_amrnb_be_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_amrwb_oa_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_amrwb_oa_plugin_def_t->name, tdav_codec_amrwb_oa_plugin_def_t->desc);
	tmedia_codec_plugin_register(tdav_codec_amrwb_be_plugin_def_t);
	TSK_DEBUG_INFO("Register codec: %s, %s", tdav_codec_amrwb_be_plugin_def_t->name, tdav_codec_amrwb_be_plugin_def_t->desc);
#endif
#if HAVE_BV16
...
#if !defined(HAVE_TINYMCPTT) || HAVE_TINYMCPTT
	//MCPTT
	tmedia_session_plugin_unregister(tdav_session_mcptt_plugin_def_t);
	tmedia_session_plugin_unregister(tdav_session_mbmsaudio_plugin_def_t);
#endif
